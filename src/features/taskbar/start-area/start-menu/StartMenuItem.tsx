...
export const StartMenuItem = ({ getBinary }: Props) => {
  ...
  return (
    <li onMouseDown={switchOn({ lmb: handleLmb, rmb: handleRmb } as const)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} ref={startMenuItemRef} style={isHovering ? hoverStyle : style}>
